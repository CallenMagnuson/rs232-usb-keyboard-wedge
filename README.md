...
\
This was designed to use as an RS-232 to USB HID Keyboard wedge to type keyboard shortcuts on another device, but will support typing strings of text.\
\
